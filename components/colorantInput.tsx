...
interface ColorantInputProps {
  child: string; // "input" or "output"
  inputkey: string;
}

const ColorantInput: React.FC<ColorantInputProps> = ({ child, inputkey }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    axios
      .post("http://127.0.0.1:8080/colorant", data)
      .then((response) => {
